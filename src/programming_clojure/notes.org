...
- Seqing streams
  - A reader provides a stream of characters. You can seq over the
    lines of any reader using `line-seq`
  - To get a reader use *clojure.java.io*

    #+BEGIN_SRC clojure
      (require '[clojure.java.io :as io])
      ;; leaves reader open...
      (take 2 (line-seq (io/reader "project.clj")))
      ;; this is bad code. Reader can represent non memory resources that
      ;; needs to be closed. Therefore, it should be closed using
      (with-open [reader (io/reader "project.clj")]
